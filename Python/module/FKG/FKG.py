...
def FKG(df):
    ...
    results = {
        ...
        "Test Accuracy": [listAcc],  
        "Count Train": [traindf.iloc[-1].value_counts().to_dict()],
        "Count Test": [testdf.iloc[-1].value_counts().to_dict()],
        "Count List Rank": [pd.DataFrame(listRank).value_counts().to_dict()],
        "List Rank Length": [len(listRank)]
    }
    ...
    # print("List pre: ",listPre)
    # print("List re: ",listRe)
