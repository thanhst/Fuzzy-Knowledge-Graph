...
- `Test_FIS_FKG_Full_Flow.bat [dataset] [module_dir] [bins] [warm_repeats]`
  - Run full FIS + FKG CPU/GPU benchmark.
  - `dataset`: `icta | feature_selection | both`
  - `warm_repeats`: number of warm runs after cold run (default `1`)
  - default: `both`
...
Bat run\Test_FIS_FKG_Full_Flow.bat both source 6 1
