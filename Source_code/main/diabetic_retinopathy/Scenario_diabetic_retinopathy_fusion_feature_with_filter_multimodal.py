...
# from module.Processing_Data import Diabetic_fusion_processing_with_filter_multimodel_fs
# Diabetic_fusion_processing_with_filter_multimodel_fs.processing(file_path_table="data/Dataset_diabetic/data_process.csv",file_path_img="data/Image/fundus_photo",folder_save="Fusion_feature_filter",k_img=7,k_tab=9,corr= 0.95)

# print("__________Running FIS___________")
# FIS(fileName="Diabetic Retinopathy Feature Filter",
#     filePath=os.path.join(project_root,"data\Dataset_diabetic\Fusion_feature_filter\data_process.csv"),
