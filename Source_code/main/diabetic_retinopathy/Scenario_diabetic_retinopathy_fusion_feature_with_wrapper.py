...
print("Diabetic Retinopathy Fusion Feature Wrapper")

# print("__________Running Processing___________")
# from module.Processing_Data import Diabetic_fusion_processing_with_wrapper
# Diabetic_fusion_processing_with_wrapper.processing(file_path_table="data/Dataset_diabetic/data_process.csv",file_path_img="data/Image/fundus_photo",folder_save="Fusion_feature_wrapper",max_img=7,max_tab=9)

# print("__________Running FIS___________")
# FIS(fileName="Diabetic Retinopathy Feature Wrapper",
#     filePath=os.path.join(project_root,"data\Dataset_diabetic\Fusion_feature_wrapper\data_process.csv"),
...
for i in r:
    for j in e:
        ...
        traindf = pd.read_csv(os.path.join(project_root,'data/FIS/output/Diabetic Retinopathy Feature Wrapper/Rule_List_All.csv'))
...
#     fkg_instance = FKGS()
#     fkg_instance.FKGS(df = train_combined,testdf=val_combined,Turn=None,Modality="Diabetic Retinopathy Feature Wrapper",ran=20,e=0.2)
#     print("-"*100)
