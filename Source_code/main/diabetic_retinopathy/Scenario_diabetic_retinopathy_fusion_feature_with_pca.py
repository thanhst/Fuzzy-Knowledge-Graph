...
test = [[int(float(x)) for x in row] for row in testdf.values]
fkg_instance = FKGS()
fkg_instance.FKGS(df = base,testdf=test,Turn=None,Modality="Diabetic Retinopathy Feature PCA",ran=20,e=0.2,folderPath=project_root)
print("-"*100)
...
#     fkg_instance = FKGS()
#     fkg_instance.FKGS(df = train_combined,testdf=val_combined,Turn=None,Modality="Diabetic Retinopathy Feature PCA",ran=20,e=0.2,folderPath=project_root)
#     print("-"*100)
