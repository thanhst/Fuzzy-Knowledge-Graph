...
for i in range(epoch):
    ...
    for j in range(len(fkg_instance.weight)):
        ...
        file_plus = fkg_instance.Cross_weight_with_i(path_file=fis_file,file_name = fis_name,weight=fkg_instance.weight,h=1e-15,plus_or_minus="plus",i=j)
        ...
        file_minus = fkg_instance.Cross_weight_with_i(path_file=fis_file,file_name = fis_name,weight=fkg_instance.weight,h=-1e-15,plus_or_minus="minus",i=j)
