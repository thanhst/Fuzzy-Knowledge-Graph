...
# from module.Processing_Data import Diabetic_processing

print("__________Running FIS___________")
# FIS(fileName="Diabetic Retinopathy Feature",
#     filePath=".\data\Dataset_diabetic\data_process.csv",
...
test = [[int(float(x)) for x in row] for row in testdf.values]
fkg_instance = FKGS()
fkg_instance.FKGS(df = base,testdf=test,Turn=None,Modality="Diabetic Retinopathy Feature",ran=20,e=0.2)
print("-"*100)
