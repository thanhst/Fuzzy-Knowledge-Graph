...
def process(path_img="data/Image/fundus_photo/",folder = "Fusion_feature",n_components = 7):
    list_of_images = []
    path_of_images = os.path.join(base_path,path_img)
    ...
    if os.path.exists(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv')):
        os.remove(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv'))
    if not os.path.exists(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv')):
        with open(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv'), mode='w', newline='') as f:
            writer = csv.writer(f)
            writer.writerow([
                "image_id",
                "Contrast Feature",
    ...
    for image in list_of_images:
        ...
        with open(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv'), mode='a', newline='') as f:
            writer = csv.writer(f)
            writer.writerow([
        ...
        df = pd.read_csv(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv'))
        ...
        df_pca.to_csv(os.path.join(base_path,f'data/Dataset_diabetic/{folder}/images_ft.csv'))
