...
def segment_with_otsu_and_kmeans(image, k=2):
    ...
    combined_mask = otsu_mask  # Chỉ giữ lại các vùng mà cả Otsu và KMeans đều xác nhận
...
list_of_images = []
name_of_images = []
path_of_images = os.path.join(base_path,"data/Image/test_diabetic_renopathy/")
...
os.makedirs(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical_test"), exist_ok=True)
df.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical_test/images_ft.csv"),index=False)
...
dfData = pd.read_csv(os.path.join(base_path,"data/Dataset_diabetic/test_data.csv"))
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical_test/data_process.csv"),index=False)
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical_test/correlation_matrix.csv"), index=False)
