...
os.makedirs(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_glcm_test"), exist_ok=True)
df.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_glcm_test/images_ft.csv"),index=False)
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_glcm_test/data_process.csv"),index=False)
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_glcm_test/correlation_matrix.csv"), index=False)
