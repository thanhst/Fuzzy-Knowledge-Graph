...
def apply_clahe(image):
    ...
    clahe = cv2.createCLAHE(clipLimit=3.0, tileGridSize=(72,72))
    cl = clahe.apply(l)
...
os.makedirs(os.path.join(base_path,"data/Dataset_diabetic/Image_feature_test"), exist_ok=True)
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Image_feature_test/data_process.csv"),index=False)
