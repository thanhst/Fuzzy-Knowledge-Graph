...
os.makedirs(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical"), exist_ok=True)
...
for image in list_of_images:
    ...
    with open(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical/images_ft.csv"), mode='a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([
...
df = pd.read_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical/images_ft.csv"))
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical/data_process.csv"),index=False)
...
dfMerge.to_csv(os.path.join(base_path,"data/Dataset_diabetic/Fusion_feature_with_statistical/correlation_matrix.csv"), index=False)
